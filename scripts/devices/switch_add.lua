-- Create an inwall switch device
local function switch_add(gw, name, room, remote_id, meters)
...
--	end
	...
	local newdev,err = core.add_device{
			...
			info = {manufacturer = "Rene Boer", model = "VeraBridge Switch", remote_id = remote_id}
		}
	if newdev then
